...
public class UsarPosicoesDoFutebol {
    public static void main(String[] args) {
        ...
        corinthans.lateralDireito = "Matheuzinho (ou Léo Maná)";
        corinthans.lateralEsquerdo = "Hugo";
        corinthans.zagueiro1 = "Cacá";
        corinthans.zagueiro2 = "Caetano";
        corinthans.vol1 = "Raniele";
        corinthans.vol2 = "Breno Bidon";
        corinthans.meia1 = "Rodrigo Garro";
        corinthans.meia2 = "Igor Coronado";
